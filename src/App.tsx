        ...
        <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in duration-200">
            <div className="bg-[#0a0a0f] border border-[#1a1a24] w-full max-w-sm rounded-xl p-5 shadow-2xl flex flex-col gap-4 relative">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <a href="https://github.com/tu-usuario/veloclips" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-lg bg-[#0c0c10] border border-[#1a1a24] hover:border-gray-500 transition-colors text-sm font-medium">
                        <svg viewBox="0 0 24 24" width="18" height="18" stroke="currentColor" strokeWidth="2" fill="none" strokeLinecap="round" strokeLinejoin="round"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>
                        Repositorio Oficial (GitHub)
                    </a>
                    
                    <a href="https://ko-fi.com/tu-usuario" target="_blank" rel="noreferrer" className="flex items-center gap-3 p-3 rounded-lg bg-[#1a0933] border border-[#b026ff]/30 hover:border-[#b026ff] transition-colors text-sm font-medium text-[#e0b0ff]">
